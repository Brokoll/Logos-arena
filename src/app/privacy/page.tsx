                            ...
                            <table className="w-full text-left text-sm border-collapse">
                                ...
                                <tbody>
                                    <tr className="border-b-[2px] border-foreground">
                                        ...
                                        <td className="p-4 border-r border-foreground text-center font-black text-[10px] uppercase">필수</td>
                                    ...
                                    <tr className="border-b-[2px] border-foreground">
                                        ...
                                        <td className="p-4 border-r border-foreground text-center font-black text-[10px] uppercase">플랫폼</td>
